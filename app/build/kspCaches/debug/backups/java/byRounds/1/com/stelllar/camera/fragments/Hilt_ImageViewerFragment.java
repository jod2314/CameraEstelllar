...
public abstract class Hilt_ImageViewerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImageViewerFragment() {
    super();
  }

  Hilt_ImageViewerFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImageViewerFragment_GeneratedInjector) this.generatedComponent()).injectImageViewerFragment(UnsafeCasts.<ImageViewerFragment>unsafeCast(this));
    }
  }
