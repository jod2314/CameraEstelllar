...
public abstract class Hilt_PermissionsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PermissionsFragment() {
    super();
  }

  Hilt_PermissionsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PermissionsFragment_GeneratedInjector) this.generatedComponent()).injectPermissionsFragment(UnsafeCasts.<PermissionsFragment>unsafeCast(this));
    }
  }
