...
public abstract class Hilt_SelectorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SelectorFragment() {
    super();
  }

  Hilt_SelectorFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SelectorFragment_GeneratedInjector) this.generatedComponent()).injectSelectorFragment(UnsafeCasts.<SelectorFragment>unsafeCast(this));
    }
  }
