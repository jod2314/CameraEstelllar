...
public abstract class Hilt_CameraFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CameraFragment_GeneratedInjector) this.generatedComponent()).injectCameraFragment(UnsafeCasts.<CameraFragment>unsafeCast(this));
    }
  }
